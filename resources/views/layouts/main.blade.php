...
<html>
<head>
<title>EEcommerce Online Shopping</title>
<!--/tags -->
...
<link href="{{asset('dist/css/easy-responsive-tabs.css')}}" rel='stylesheet' type='text/css'/>
							...
							<ul class="dropdown-menu multi-column columns-3">
								<div class="agile_inner_drop_nav_info">
									<div class="col-sm-6 multi-gd-img1 multi-gd-text ">
										<a href="mens.html"><img src="dist/images/top2.jpg" alt=" "/></a>
									</div>
							...
							<ul class="dropdown-menu multi-column columns-3">
								<div class="agile_inner_drop_nav_info">
									...
									<div class="col-sm-6 multi-gd-img multi-gd-text ">
										<a href="womens.html"><img src="dist/images/top1.jpg" alt=" "/></a>
									</div>
									<div class="clearfix"></div>
								</div>
							</ul>
...
<div class="footer">
	<div class="footer_agile_inner_info_w3l">
		...
		<div class="col-md-9 footer-right">
			<div class="sign-grds">
				...
				<div class="col-md-3 sign-gd flickr-post">
					...
					<ul>
						<li><a href="single.html"><img src="dist/images/t1.jpg" alt=" " class="img-responsive" /></a></li>
						<li><a href="single.html"><img src="dist/images/t2.jpg" alt=" " class="img-responsive" /></a></li>
						<li><a href="single.html"><img src="dist/images/t3.jpg" alt=" " class="img-responsive" /></a></li>
						<li><a href="single.html"><img src="dist/images/t4.jpg" alt=" " class="img-responsive" /></a></li>
						<li><a href="single.html"><img src="dist/images/t1.jpg" alt=" " class="img-responsive" /></a></li>
						<li><a href="single.html"><img src="dist/images/t2.jpg" alt=" " class="img-responsive" /></a></li>
						<li><a href="single.html"><img src="dist/images/t3.jpg" alt=" " class="img-responsive" /></a></li>
						<li><a href="single.html"><img src="dist/images/t2.jpg" alt=" " class="img-responsive" /></a></li>
		...
		<p class="copy-right">&copy 2017 Elite shoppy. All rights reserved</a></p>
	</div>
</div>
<!-- //footer -->
...
<script src="{{asset('dist/js/modernizr.custom.js')}}"></script>
	...
	<!-- cart-js -->
	<script src="{{asset('dist/js/minicart.min.js')}}"></script>
<script>
	// Mini Cart
...
<script src="{{asset('dist/js/easy-responsive-tabs.js')}}"></script>
<script>
